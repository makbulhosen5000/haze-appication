...
{{-- @dd($prefix); --}}
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('home')}}" class="brand-link">
      <img src="{{asset('backend')}}/dist/img/logo.png" alt="logo.png" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      {{-- <li class="nav-item has-treeview {{($prefix=='/about')?'menu-open':''}} ">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="{{route('about.testimonial.view')}} " class="nav-link {{($route=='about.testimonial.view')?'active':''}}">
                <i class="far fa-circle nav-icon"></i>
                <p>Testimonial</p>
              </a>
            </li>
