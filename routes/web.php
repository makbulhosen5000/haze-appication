...
Route::group(['middleware' => ['test']], function () {
    ...
    Route::prefix('about')->group(function () {
        ...
        Route::get('career/destroy/{id}', [CareerController::class, 'destroy'])->name('about.career.destroy');
         //__ Career routes start from here __//
         Route::get('testimonial/view', [TestimonialController::class, 'index'])->name('about.testimonial.view');
         Route::get('testimonial/create', [TestimonialController::class, 'create'])->name('about.testimonial.create');
         Route::post('testimonial/store', [TestimonialController::class, 'store'])->name('about.testimonial.store');
         Route::get('testimonial/edit/{id}', [TestimonialController::class, 'edit'])->name('about.testimonial.edit');
         Route::post('testimonial/update/{id}', [TestimonialController::class, 'update'])->name('about.testimonial.update');
         Route::get('testimonial/destroy/{id}', [TestimonialController::class, 'destroy'])->name('about.testimonial.destroy');
    });
